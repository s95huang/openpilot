...
class CarController():
  def __init__(self, dbc_name, CP, VM):
    ...
    self.lka_steering_cmd_counter_last = -1  # loopback
    self.sent_lka_steering_cmd_counter = -1  # last sent
  ...
  def update(self, c, enabled, CS, frame, actuators,
    ...
    if CS.lka_steering_cmd_counter != self.lka_steering_cmd_counter_last:
      ...
      # ensure we got a loopback since the last send
      # else, wait for the next steer cycle to send
      if self.sent_lka_steering_cmd_counter != idx:
        ...
        if lkas_enabled:
          ...
          self.sent_lka_steering_cmd_counter = idx
